...
export default class ActionButtonCircleItem extends Component {
    ...
    render() {
        ...
        return (
            <SafeAreaView>
                ...
                >
                    <TouchableOpacity style={{flex: 1}} activeOpacity={this.props.activeOpacity || 0.85}
...
ActionButtonCircleItem.propTypes = {
...
ActionButtonCircleItem.defaultProps = {
    onPress: () => {
    },
    startDegree: 0,
    endDegree: 720
