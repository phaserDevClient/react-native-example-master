...
export default class RecyclerListViewWithData extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    renderFooter = () => {
        ...
        return this.inProgressNetworkReq ? <ActivityIndicator style={{margin: 10}}
                                                              size="large"
                                                              color={'black'}/> :
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <ViewSelector viewType={this.state.viewType}
